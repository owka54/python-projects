...
for i in range(num_of_enemies):
    ...
    enemyBulletImg.append(pygame.image.load("images/bomb.png"))
    enemyBulletX.append(250)
    enemyBulletY.append(100)
...
def enemy_fire(x, y, i):
    global enemyBullet_state
    enemyBullet_state[i] = "fire"
    screen.blit(enemyBulletImg[i], (x + 16, y + 10))
...
while running:
    ...
    for i in range(num_of_enemies):
        ...
        # Game over
        dead = isCollision(playerX, playerY, enemyBulletX[i], enemyBulletY[i])
        ...
        if x == 32:
            enemy_fire(enemyBulletX[i], enemyBulletY[i], i)
    ...
    if enemyBullet_state[i] == "fire":
        enemyBulletY[i] += enemyBulletY_change
        enemy_fire(enemyBulletX[i], enemyBulletY[i], i)
